    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipoIdentificacion', models.CharField(choices=[('CEDULA', 'CEDULA'), ('RUC', 'RUC'), ('PASAPORTE', 'PASAPORTE'), ('IDENTIFICACION_EXTERIOR', 'IDENTIFICACION DEL EXTERIOR')], default='CEDULA', max_length=50, verbose_name='Tipo Identificacón')),
                ('identificacion', models.CharField(max_length=50, unique=True, verbose_name='Identificacón')),
                ('tipoCliente', models.CharField(choices=[('CLIENTE', 'CLIENTE'), ('SUJETO_RETENIDO', 'SUJETO RETENIDO'), ('DESTINATARIO', 'DESTINATARIO')], default='CLIENTE', max_length=50, verbose_name='Tipo Cliente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ambiente', models.CharField(max_length=100, verbose_name='Ambiente')),
                ('codDoc', models.CharField(max_length=50, verbose_name='Código Documento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precioTotalSinImpuesto', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Precio Total Sin Impuesto')),
            ],
        ),
        migrations.CreateModel(
            name='Impuesto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('formaPago', models.CharField(choices=[('SIN_UTILIZACION_FINANCIERA', '01-SIN UTILIZACIÓN DEL SISTEMA FINANCIERO'), ('COMPESACION_DEUDAS', '15-COMPESACIÓN DE DEUDAS'), ('TARJETA_DEBIDO', '16-TARJETA DE DEBITO'), ('DINERO_ELECTRONICO', '17-DINERO ELECTRONICO'), ('TARJETA_PREPAGO', '18-TARJETA PREPAGO'), ('TARJETA_CREDITO', '19-TARJETA DE CREDITO'), ('OTROS', '20-OTROS CON UTILIZACIÓN DEL SISTEMA FINANCIERO'), ('ENDOSO_TITULOS', '21-ENDOSO DE TITULOS')], default='SIN_UTILIZACION_FINANCIERA', max_length=50, verbose_name='Forma de Pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('impuestos', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facturacion.detalleadicional', verbose_name='Impuesto')),
            ],
        ),
        migrations.CreateModel(
            name='Destinatario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaEmision', models.DateField(verbose_name='Fecha Emisión')),
                ('nombreComercial', models.CharField(max_length=100, verbose_name='Nombre Comercial')),
                ('obligadoContabilidad', models.CharField(max_length=100, verbose_name='Obligado a LLevar Contabilidad')),
                ('ptoEmision', models.CharField(max_length=100, verbose_name='pto Emisión')),
                ('razonSocial', models.CharField(max_length=100, verbose_name='Razón Social')),
                ('ruc', models.CharField(max_length=13, verbose_name='RUC')),
                ('secuencial', models.CharField(max_length=100, verbose_name='Secuencial')),
                ...
                ('cliente', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='facturacion.campoadicional', verbose_name='Cliente')),
                ('configAplicacion', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='facturacion.configcorreo', verbose_name='Configuración Aplicación')),
                ('configCorreo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='facturacion.configaplicacion', verbose_name='Configuración Correo')),
            ],
        ),
        migrations.CreateModel(
            name='NotaDebito',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalles', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facturacion.detallefactura', verbose_name='Detalles')),
                ('guiaRemision', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='facturacion.guiaremision', verbose_name='Guía Remisión')),
                ('infoAdicional', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='campoAdicional', to='facturacion.campoadicional', verbose_name='Campo Adicional')),
                ('pagos', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facturacion.pagos', verbose_name='Pagos')),
                ('totalConImpuesto', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='facturacion.totalimpuesto', verbose_name='Total con Impuesto')),
            ],
            bases=('facturacion.comprobantegeneral',),
